...
public class AdminDTO {
	...
	public int adm_phonenum;

	public AdminDTO() {
	}

	public AdminDTO(String adm_id, String adm_pw, String adm_name, int adm_number, int adm_phonenum) {
		this.adm_id = adm_id;
		this.adm_pw = adm_pw;
	...
	public AdminDTO(String[] datas) {
		...
		this.adm_phonenum = Integer.parseInt(datas[4]);
	}
